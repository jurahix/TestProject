...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    //$urlRouterProvider.otherwise("/Estudiante/Lista");
    $urlRouterProvider.otherwise("/Login/Acceso")
...
//RUTAS ESTUDIANTE      
        ...
        .state('Estudiante.Nuevo', {
            url: "/Nuevo",
            templateUrl: "views/Estudiante/Nuevo.html",
            data: { pageTitle: 'Registro de Nuevo Estudiante' }
        })
        .state('Estudiante.Lista', {
            url: "/Lista",
            templateUrl: "views/Estudiante/Listar.html",
            data: { pageTitle: 'Lista de los Estudiantes' }
        })
        .state('Estudiante.Parentezco', {
            url: "/Parentezco",
            templateUrl: "views/Estudiante/Parentezco.html",
            data: { pageTitle: 'Parentezco del Estudiante' }
        })
        .state('Estudiante.Contacto', {
            url: "/Contacto",
            templateUrl: "views/Estudiante/Contacto.html",
            data: { pageTitle: 'Contacto del Estudiante' }
        })
...
//RUTAS MATRICULA
        ...
        .state('Matricula.Nuevo', {
            url: "/Nuevo",
            templateUrl: "views/Matricula/Nuevo.html",
            data: { pageTitle: 'Registro de Nueva Matricula' }
        })
        .state('Matricula.Lista', {
            url: "/Lista",
            templateUrl: "views/Matricula/Listar.html",
            data: { pageTitle: 'Lista de Matricula' }
        })
        .state('Matricula.Validar', {
            url: "/Validar",
            templateUrl: "views/Matricula/Validar.html",
            data: { pageTitle: 'Registro de Nueva Matricula' }
        })
...
//RUTAS PAGO
        ...
        .state('Pago.Nuevo', {
            url: "/Nuevo",
            templateUrl: "views/Pago/Nuevo.html",
            data: { pageTitle: 'Registro de Nuevo Pago' }
        })
        .state('Pago.Validar', {
            url: "/Validar",
            templateUrl: "views/Pago/Validar.html",
            data: { pageTitle: 'Registro de Nueva Pago' }
        })


//RUTAS UBIGEO Fichasec
        .state('Fichasec', {
            abstract: true,
            url: "/Ficha",
            templateUrl: "views/common/content.html",
        })
        .state('Fichasec.Nuevo', {
            url: "/Nuevo",
            templateUrl: "views/Fichasec/Nuevo.html",
            data: { pageTitle: 'Registro de Pregunta' }
        })
        .state('Fichasec.Lista', {
            url: "/Preguntas",
            templateUrl: "views/Fichasec/Listar.html",
            data: { pageTitle: 'Fecha SEC' }
        })
...
//RUTAS MANTENIMIENTO
        ...
        .state('Mantenimiento.Nuevo', {
            url: "/Nueva",
            templateUrl: "views/Mantenimiento/Nuevo.html",
            data: { pageTitle: 'Registro de Nuevo Mantenimiento' }
        })
        .state('Mantenimiento.Lista', {
            url: "/Mantenimientos",
            templateUrl: "views/Mantenimiento/Listar.html",
            data: { pageTitle: 'Lista de Mantenimiento' }
        })
...
//RUTAS Login
        ...
        .state('Login.Nuevo', {
            url: "/Nuevo",
            templateUrl: "views/Login/Nuevo.html",
            data: { pageTitle: 'Registro de Nuevo Estudiante' }
        })
        .state('Login.Index', {
            url: "/Acceso",
            templateUrl: "views/Login/Index.html",
            data: { pageTitle: 'Acceso al Sistema' }
        })
...
//RUTAS NOTAS
        ...
        .state('Nota.Lista', {
            url: "/Notas",
            templateUrl: "views/Nota/Matriculados.html",
            data: { pageTitle: 'Nota de los Estudiantes' }
        })
...
//RUTA ASISTENCIA
        ...
        .state('Asistencia.Lista', {
            url: "/Asistencias",
            templateUrl: "views/Asistencia/Listar.html",
            data: { pageTitle: 'Asistencia de los Estudiantes' }
        })
...
//RUTAS ENCUESTA
        ...
        .state('Encuesta.Responder', {
            url: "/Nuevo",
            templateUrl: "views/Encuesta/Responder.html",
            data: { pageTitle: 'Rellenar la Encuesta' }
        })
        .state('Encuesta.Lista', {
            url: "/Lista",
            templateUrl: "views/Encuesta/Lista.html",
            data: { pageTitle: 'Encuestas Activas' }
        })
